...
//const currentFontSise = ref.textRef.getAttribute('style');

//console.log('currentFontSise', currentFontSise)

function changeFont(event) {
    ref.textRef.style.fontSize = event.target.value +"px";
};
ref.inputRef.addEventListener('input', changeFont);
